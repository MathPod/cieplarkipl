...
<html lang="pl">
  ...
  <body>
    <div class="myContainer">
            ...
            <a href="/">
                <div class="deviceBox categoryLvl2deviceBox">
                    <div class="devicePhotoBoxLvl2Category" style="background-image: url(./img/zamrazarka-laboratoryjna.webp);"></div>
                    <div class="titleBarLvl2Category"><p>Chłodziarka Laboratoryjna</p></div>
                </div>
            </a>  
            <a href="/">
                <div class="deviceBox categoryLvl2deviceBox">
